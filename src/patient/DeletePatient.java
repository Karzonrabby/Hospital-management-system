...
public class DeletePatient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setBounds(0, 130, 1050, 402);
        ...
        bradcum_label.setText("Patient Panel >> Delete Patient");
        delete_panel.add(bradcum_label);
        bradcum_label.setBounds(10, 30, 410, 60);
    ...
    private void delete_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_btnActionPerformed
        ...
        try{
            pst = conn.prepareStatement(sql);
            pst.setString(1, serialNo_txt.getText());
            pst.execute();
