 ...
 * @author mahad
 */
public class DeleteReceptionPage extends javax.swing.JFrame {

    private Connection conn;
    private PreparedStatement pst;
    private ResultSet rs;
    
    public DeleteReceptionPage() {
        initComponents();
        fetch_table();
        setIconImage();
    }
    ...
    private void initComponents() {
        ...
        bradcum_label.setText("Reception Panel >> Delete Receptionist");
        delete_panel.add(bradcum_label);
        bradcum_label.setBounds(10, 40, 530, 60);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteReceptionPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteReceptionPage().setVisible(true);
            }
        });
    }
