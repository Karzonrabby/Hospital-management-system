 ...
 * @author mahad
 */
public class SearchReceptionPage extends javax.swing.JFrame {

    private Connection conn = null;
    private PreparedStatement pst = null;
    private ResultSet rs = null;
    
    public SearchReceptionPage() {
        initComponents();
        fetch_table();
        setIconImage();
    }
    ...
    private void initComponents() {
        ...
        table.setBounds(10, 162, 1030, 440);
        ...
        bradcum_label.setText("Recepiton Panel >> Search Receptionist");
    ...
    private void search_txtKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_search_txtKeyReleased
        conn = Connector.ConnectDB();
        try{
            String sql = "SELECT * FROM reception WHERE Name = ?";
            pst = conn.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchReceptionPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SearchReceptionPage().setVisible(true);
            }
        });
    }
