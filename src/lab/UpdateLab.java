 ...
 * @author mahad
 */
public class UpdateLab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        update_panel.add(jScrollPane1);
        jScrollPane1.setBounds(12, 130, 1030, 402);
        ...
        bradcum_label.setText("Laboratorist Panel >> Update Laboratorist");
    ...
    private void update_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_update_btnActionPerformed
        try{
            ...
            String sql = "UPDATE `lab` SET `ID` = '"+id+"', `Name` = '"+name+"', `Email` = '"+email+"', `Age` = '"+age+"', `Gender` = '"+gender+"', `Address` = '"+address+"', `Phone` = '"+phone+"', `Join Date` = '"+date+"', `BG` = '"+blood+"', `Status` = '"+status+"' WHERE `lab`.`ID` = '"+id+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateLab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
