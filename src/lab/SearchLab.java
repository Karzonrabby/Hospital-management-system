 ...
 * @author mahad
 */
public class SearchLab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bradcum_label.setText("Laboratorist Panel >> Search Laboratorist");
        search_panel.add(bradcum_label);
        bradcum_label.setBounds(10, 30, 550, 60);
        ...
        search_panel.add(jScrollPane1);
        jScrollPane1.setBounds(12, 162, 1030, 370);

        bg_label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lab/AllBackGrondPic.jpg"))); // NOI18N
        search_panel.add(bg_label);
        bg_label.setBounds(0, 4, 1050, 610);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(search_panel, javax.swing.GroupLayout.DEFAULT_SIZE, 615, Short.MAX_VALUE)
                .addContainerGap())
        );
...
//        try{
//            conn = Connector.ConnectDB();
//            int row = lab_table.getSelectedRow();
//            String tableClick = (lab_table.getModel().getValueAt(row, 0).toString());
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SearchLab.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
