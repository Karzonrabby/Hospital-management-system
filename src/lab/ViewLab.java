...
public class ViewLab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        view_lab.add(jScrollPane1);
        jScrollPane1.setBounds(12, 130, 1030, 402);

        bradcum_label.setFont(new java.awt.Font("Lucida Sans Unicode", 1, 18)); // NOI18N
        bradcum_label.setForeground(new java.awt.Color(255, 255, 255));
        bradcum_label.setText("Laboratorist Panel >> View Laboratorist");
        view_lab.add(bradcum_label);
        bradcum_label.setBounds(0, 30, 400, 70);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(view_lab, javax.swing.GroupLayout.DEFAULT_SIZE, 604, Short.MAX_VALUE)
                .addContainerGap())
        );
