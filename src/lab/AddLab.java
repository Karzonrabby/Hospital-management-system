...
public class AddLab extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bradcum_label.setText("Laboratorist Panel >> Add Laboratorist");
        Add_panel.add(bradcum_label);
        bradcum_label.setBounds(10, 30, 820, 70);
        ...
        bg_label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lab/AllBackGrondPic - Copy.jpg"))); // NOI18N
        Add_panel.add(bg_label);
        bg_label.setBounds(0, 0, 1050, 610);
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                .addComponent(Add_panel, javax.swing.GroupLayout.PREFERRED_SIZE, 598, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
        ...
        if(conn != null){
            ...
            String sql = "INSERT INTO `lab` (`ID`, `Name`,`Email`,  `Phone`, `Address`, `Age`, `Gender`, `Join Date`, `BG`, `Status`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
            try{
