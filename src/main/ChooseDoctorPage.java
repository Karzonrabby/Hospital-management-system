...
public class ChooseDoctorPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        next_btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/next.png"))); // NOI18N
        ...
        search_btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Search-icon.png"))); // NOI18N
        ...
        choose_doctor_panel.add(time_label);
        time_label.setBounds(810, 30, 60, 50);

        background_label.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reception/AllBackGrondPic - Copy.jpg"))); // NOI18N
    ...
    private void search_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_btnActionPerformed
        ...
        String sql = "select `ID`, `Name`, `Email`, `Age`, `Gender`, `Address`, `Department`, `Phone`, `Join Date`, `Blood Group`, `Status` from doctor where `Department` = '" + searchKey + "'";
        try {
            ...
            while (rs.next()) {
                ...
                columnData[9] = rs.getString("Blood Group");
...
//        String searchKey = (String) department_box.getSelectedItem();
//        try{
//            String sql = "SELECT * FROM doctor WHERE Name = '" + searchKey + "' ";
//            pst = conn.prepareStatement(sql);
//            
//            pst.setString(1, (String) department_box.getSelectedItem());
//            pst.setString(2, (String) department_box.getSelectedItem());
//            pst.setString(3, (String) department_box.getSelectedItem());
//            pst.setString(4, (String) department_box.getSelectedItem());
//            pst.setString(5, (String) department_box.getSelectedItem());
//            pst.setString(6, (String) department_box.getSelectedItem());
//            pst.setString(7, (String) department_box.getSelectedItem());
//            pst.setString(8, (String) department_box.getSelectedItem());
//            pst.setString(9, (String) department_box.getSelectedItem());
//            pst.setString(10, (String) department_box.getSelectedItem());
//            pst.setString(11, (String) department_box.getSelectedItem());
...
//        }
    ...
    private void back_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_back_btnActionPerformed
        RepMainPage lhp = new RepMainPage();
        lhp.setVisible(true);
        dispose();
